...
SKILL_SHOULDER_CHARGE <- 1 		  //  001.鐵山?
...
SKILL_JUMP_POWER_UP <- 175 		  //  躍翔
SKILL_MAGICAL_ATTACK_UP <- 176 		  //  遠古記憶
SKILL_THROW_MASTERY <- 177 		  //  投擲精通
SKILL_PHYSICAL_BACK_ATTACK_CRITICAL <- 178 		  //  物理背擊
SKILL_DISJOINT_ITEM <- 179 		  //  아이템 해체
SKILL_SUPER_ARMOR_ON_CAST <- 180 		  //  不屈意志
