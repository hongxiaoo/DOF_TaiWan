...
CUSTOM_ANI_windtest				<- 11	// 윈드 스트라이크
...
//	`ATAnimation/IceElementalAttack1.ani`
// 	`ATAnimation/IceElementalAttack2.ani`
// 	`ATAnimation/IceElementalAttack3.ani`
// 	`ATAnimation/IceElementalDashAttack.ani`
// 	`ATAnimation/IceElementalJumpAttack.ani`
//ICE ATTACK ANI
