...
// ??? ??
//******************************************************************************************
IRDSQRCharacter.pushScriptFiles("Character/ATMage/atmage_header.nut");	// ??? ???? ??? ?? ??? ??(enum? ??)
IRDSQRCharacter.pushScriptFiles("Character/ATMage/atmage_common.nut"); //  ??? state? ?????? ?? ??? ?? ?? ???
//IRDSQRCharacter.pushScriptFiles("Character/ATMage/atmage_throw.nut"); //  state_throw?? ??????? ?????.
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_AT_MAGE, "Character/ATMage/DPThunder/DPThunder.nut", "DPThunder", STATE_DP_THUNDER, SKILL_DP_THUNDER);
...
IRDSQRCharacter.pushPassiveObj(path, 24284);	// ??????(??) ?? ?? ????
IRDSQRCharacter.pushPassiveObj(path, 24285);	// ??????(??) ? ?? ????
IRDSQRCharacter.pushPassiveObj(path, 24286);	// ??????(??) ??? ????
...
// ???? ??? ???? NUT?? ??
//******************************************************************************************
IRDSQRCharacter.pushPassiveObj("Character/ATMage/CrystalAttack/po_CrystalCore.nut", 24221); 	// 24221	`Character/Mage/CrystalCore.obj`	// ??? - ??????
...
// ?? : ??? ??
IRDSQRCharacter.pushPassiveObj("Character/ATMage/IceOrbEx/po_ATIceOrbEx.nut", 24235); // ??? : ?? ??? ?? (??)
IRDSQRCharacter.pushPassiveObj("Character/ATMage/IceOrbEx/po_ATIceOrbExPrickle.nut", 24236); // ??? : ?? ??? ?? (??)

// ?? : ??? ??
IRDSQRCharacter.pushPassiveObj("Character/ATMage/IceFieldEx/po_ATIceFieldEx.nut", 24237); // ??? : ?? ??? ??
